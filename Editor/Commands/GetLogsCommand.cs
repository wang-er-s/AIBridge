...
AIBridgeCLI Log --filter ""NullReference"" --count 30",
        ...
        {
            yield return ToCommandResult(
                AIBridgeLogService.GetLogs(logType, filter, count, true));
        }
...
AIBridgeCLI GetLogsCommand_StartCapture")]
        public static IEnumerator StartCapture(
            ...
            int runtimeTimeout = AIBridgeProtocol.DefaultExecutionTimeoutMs)
        {
            yield return ToCommandResult(AIBridgeLogService.StartCapture());
        }
...
AIBridgeCLI GetLogsCommand_StopCapture")]
        public static IEnumerator StopCapture(
            ...
            int runtimeTimeout = AIBridgeProtocol.DefaultExecutionTimeoutMs)
        {
            yield return ToCommandResult(AIBridgeLogService.StopCapture());
        }

        private static CommandResult ToCommandResult(AIBridgeLogServiceResult result)
        {
